...
![NGINX](./screenshots/AS4T0SS1.png)
...
![EXTRACT](./screenshots/AS4T1SS1.png)
...
![FOOTER](./screenshots/AS4T2SS2.png)
...
![NGNXOK](./screenshots/AS4T3SS3.png)

---

#### Screenshot 4 — Output of `ls /var/www/html` showing deployed website files

![Website Files ](./screenshots/AS4T3SS4.png)
...
![ifconfig.me](./screenshots/AS4T4SS5.png)

---

#### Screenshot 6 — Browser showing the live website with your Full Name and deployment details in the footer

![live website](./screenshots/AS4T4SS6.png)
...
![NGNXOK](./screenshots/AS4T5SS7.png)

---

#### Screenshot 8 — Output of `curl -I http://localhost` showing 200 OK

![localhosthost](./screenshots/AS4T5SS8.png)
...
![localhosthost](./screenshots/AS4_LINKEDIN.png)
