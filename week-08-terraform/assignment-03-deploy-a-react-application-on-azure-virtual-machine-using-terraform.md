...
![TF VERSION](./screenshots/AS3T0SS1.png)
...
![AZ VERSION](./screenshots/AS3T0SS2.png)
...
![TF EXTENSION](./screenshots/AS3T0SS3.png)
...
![cloud-init.sh](./screenshots/AS3T1SS6.png)
...
![output](./screenshots/AS3T1SS7.png)
...
![apply](./screenshots/AS3T3SS10.png)
...
![output](./screenshots/AS3T3SS11.png)

## VM Public IP Address

Record the public IP address displayed by `terraform output`.

**VM Public IP Address:** http://172.198.75.141/
...
![nginx](./screenshots/AS3T4SS13.png)
...
![destroy](./screenshots/AS3T6SS15.png)
