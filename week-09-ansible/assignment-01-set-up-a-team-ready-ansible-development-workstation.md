...
![WORKSPACE](./screenshots/AS1T1SS1.png)
...
![ANSIBLE TOOLS](./screenshots/AS1T2SS2.png)
...
![VS CODE](./screenshots/AS1T3SS3.png)
...
![VS CODE](./screenshots/AS1T3SS4.png)
...
![validation](./screenshots/AS1T7SS10.png)
...
![project strictire](./screenshots/AS1T8SS11.png)
...
![readme](./screenshots/AS1T8SS12.png)
...
Installing Ansible inside .venv avoids mixing project dependencies with system Python packages.

---

**3. Why should Ansible be installed inside a Python virtual environment?**

A virtual environment isolates dependencies and allows the project environment to be recreated without modifying system Python.

---

**4. Why must SSH private keys and `.venv/` remain outside version control?**

Private keys are authentication secrets. The virtual environment contains generated, machine-dependent files that should be recreated from the dependency record.
